...
import io.vksn.cvs.search.component.ResultDialog;
...
public class CVSSearch extends JFrame {
	...
	private SearchPatternsPanel patternsPanel;
	...
	public CVSSearch() {
		...
		searchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				List<String> results = service.search(filesPanel.getFileList(), patternsPanel.getPatterns());
				new ResultDialog(results).setVisible(true);
			}
		});

		mainPanel.add(filesPanel);
		mainPanel.add(new SearchPatternsPanel());
